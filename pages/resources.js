        ...
        <div className={"appContainer"}>
            ...
            <Container className={"mainContainer"}>
                <ContentSection>
                    ...
                    <br></br>
                    <p>
                        For a step-to-step guide on how to use the faucets you can click here: {" "}
                        <a href="https://www.notion.so/Faucets-documentation-c24e8d683c334977b3b08aaba531fb0a"
                            target="_blank"> Faucets guide
                        </a>
                    </p>
                ...
                <ContentSection>
                    ...
                    <p>
                        To interact with any of the faucet contracts you must connect with the ROPSTEN test net.
                        To do this from metamask, click on the metamask icon in your browser and select the
                        "Ropsten Test Network" in the center top of the interface.
                        See the image below for references.
                    </p>
                    <center><img class="centerImage" alt="selecting ropsten test network" src="/ropstenNetwork.png"
                        width="35%" height="35%" />
                    </center>
                    <br></br>
                    <br></br>
                    ...
                    <ol>
                        <li>Go to the contract on ehterscan and click on the option "writeContract" or simply use the link below. </li>
                        <a href="https://ropsten.etherscan.io/address/0xbCc10bC2a24b07b598D7794FecFDb42B48a5c435#writeContract"
                            target="_blank"> Minting test $FISH</a>
                        <li>Once in "writeContract" enter the wallet you wish to add test $FISH to (rectangle "1" in the image below)</li>
                        <li>Then enter the amount of $FISH you wish to add (rectangle "2" in the image below)</li>
                        <li>Click on "Write".</li>
                        <li>This transaction will charge ropsten test eth.</li>
                        <br></br>
                        <center><img class="centerImage" alt="Minting test $FISH" src="/mintTestFish.png"
                            width="100%" height="100%" />
                        </center>
                        <p>Always make sure you are on thetest net so you dont get charge real eth.</p>
                    </ol>
                    ...
                    <br></br>
                    <ol>
                        <li>Go to the contract on ehterscan and click on the option "writeContract" or simply use the link below., connect your wallet to the ROPSTEN test net.</li>
                        <a href="https://ropsten.etherscan.io/address/0xD29E7D689096a4bb3E6bb549EFb7d23645905C6A#writeContract"
                            target="_blank"> Minting test Mutant Cat</a>
                        <li>Once in "writeContract" enter the wallet you wish to add test Mutant Cat to (rectangle "1" in the image below)</li>
                        <li>Click on "Write".</li>
                        <li>This transaction will charge test eth.</li>
                        <center><img class="centerImage" alt="Minting test Mutant Cat" src="/mintMC.png"
                            width="100%" height="100%" />
                        </center>
                        <p>Always make sure you are on the test net so you dont get charge real eth.</p>
                        <br></br>
                    </ol>
                    ...
                    <ol>
                        <li>Go to the contract on ehterscan and click on the option "writeContract" or simply use the link below., connect your wallet to the ROPSTEN test net.</li>
                        <a href="https://ropsten.etherscan.io/token/0x5bca1f0d787db9a29d907d4b37ed1b15c1af00b3#writeContract"
                            target="_blank"> Minting test Mutant Gorillas</a>
                        <li>Once in "writeContract" enter the wallet you wish to add test Mutant Cat to (rectangle "1" in the image below)</li>
                        <li>Click on "Write".</li>
                        <li>This transaction will charge test eth.</li>
                        <center><img class="centerImage" alt="Minting test Mutant Gorillas" src="/mintMC.png"
                            width="100%" height="100%" />
                        </center>
                        <p>Always make sure you are on the test net so you dont get charge real eth.</p>
                        <br></br>
